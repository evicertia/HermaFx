...
namespace HermaFx.Utils
{
	public static class AsyncHelpers
	{
		...
		private class CustomSynchronizationContext : SynchronizationContext
		{
			...
			private readonly AutoResetEvent _workItemsWaiting = new AutoResetEvent(initialState: false);
			...
			private async void PostCallback(object _)
			{
				try
				{
