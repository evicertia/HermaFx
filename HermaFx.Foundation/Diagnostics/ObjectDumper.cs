...
//
// This was taken from https://raw.githubusercontent.com/staxmanade/DumpToTex
// Code has been included here, in order to avoid issues due to original
// nuget being distributed as a 'source code' based package, causing 
// troubles on non-ms/visual-studio environments.
//
...
namespace HermaFx.Diagnostics
{
	...
	{
		/// <summary>
		/// After the Dump extension is called and the string representation of the object has been created,
		...
		/// <code>
		/// ObjectDump.WriterDelegate = msg => System.Console.WriteLine(msg);
		/// </code>
		/// </summary>
		public static Action<string> WriterDelegate = msg =>
		{
			Trace.WriteLine(msg);
		};
