...
namespace HermaFx.Iso8601Duration
{
	public class PeriodBuilderTests
	{
		...
		private static IEnumerable<Tuple<string, string>> NormalizeDuration_FromPattern_ShouldBeExpectedPattern_DataProvider()
		{
			...
			yield return new Tuple<string, string>("P1W", "P1W");
			yield return new Tuple<string, string>("P7D", "P1W");
			yield return new Tuple<string, string>("P15D", "P2W1D");
			yield return new Tuple<string, string>("P1W7D", "P2W");
			yield return new Tuple<string, string>("P4W", "P1M");
			yield return new Tuple<string, string>("P1M4W", "P2M");
			yield return new Tuple<string, string>("P48W", "P1Y");
		}
		...
		private static IEnumerable<Tuple<DurationStruct, string>> ToString_FromDurationStruct_DataProvider()
		{
			...
			yield return new Tuple<DurationStruct, string>(new DurationStruct() { Weeks = 1 }, "P1W");
			yield return new Tuple<DurationStruct, string>(new DurationStruct() { Hours = 168 }, "P1W");
			yield return new Tuple<DurationStruct, string>(new DurationStruct() { Minutes = 10080 }, "P1W");
			yield return new Tuple<DurationStruct, string>(new DurationStruct() { Seconds = 604800 }, "P1W");
			yield return new Tuple<DurationStruct, string>(new DurationStruct() { Weeks = 4 }, "P1M");
			yield return new Tuple<DurationStruct, string>(new DurationStruct() { Months = 1, Weeks = 4 }, "P2M");
			yield return new Tuple<DurationStruct, string>(new DurationStruct() { Years = 1, Weeks = 48 }, "P2Y");
		}
		...
		private static IEnumerable<Tuple<DurationStruct, TimeSpan>> ToTimeSpan_FromDurationStruct_DataProvider()
		{
			...
			yield return new Tuple<DurationStruct, TimeSpan>(new DurationStruct() { Weeks = 1 }, new TimeSpan(7, 0, 0, 0));
		}
		...
		private static IEnumerable<Tuple<string, DurationStruct>> ToDurationStruct_FromPattern_DataProvider()
		{
			...
			yield return new Tuple<string, DurationStruct>("P1W", new DurationStruct() { Weeks = 1 });
		...
		private static IEnumerable<Tuple<TimeSpan, DurationStruct>> ToDurationStruct_FromTimeSpan_DataProvider()
		{
			...
			yield return new Tuple<TimeSpan, DurationStruct>(TimeSpan.FromDays(7), new DurationStruct() { Weeks = 1 });
		}
